...
/* TriebawerkeSkilleratorBundle:Skills:edit.html.twig */
class __TwigTemplate_7b438ee2ca9c9db750e2d78817d927c7 extends Twig_Template
{
...
<form action=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_skills_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "TriebawerkeSkilleratorBundle:Skills:edit.html.twig";
    }
