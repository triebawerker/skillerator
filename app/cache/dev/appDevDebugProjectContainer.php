...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TriebawerkeSkilleratorBundle', '/var/www/Symfony/app/Resources/TriebawerkeSkilleratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TriebawerkeSkilleratorBundle', '/var/www/Symfony/src/Triebawerke/SkilleratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'skillerator', 'host' => 'localhost', 'port' => '3306', 'user' => 'admin', 'password' => 'micha', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/Symfony/src/Triebawerke/SkilleratorBundle/Entity')), 'Triebawerke\\SkilleratorBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TriebawerkeSkilleratorBundle' => 'Triebawerke\\SkilleratorBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '09e7740bcadedf1cec39d2719ca2b0e3aae05812');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/Symfony/vendor/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TriebawerkeSkilleratorBundle' => 'Triebawerke\\SkilleratorBundle\\TriebawerkeSkilleratorBundle',
            ...
            'database_port' => '3306',
            'database_name' => 'skillerator',
            'database_user' => 'admin',
            'database_password' => 'micha',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => '',
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => '09e7740bcadedf1cec39d2719ca2b0e3aae05812',
            ...
            'kernel.secret' => '09e7740bcadedf1cec39d2719ca2b0e3aae05812',
